function Hero() {
    return (
        ...
        <div className="presentation absolute left-[50%] top-[50%] translate-[-50%] font-normal flex flex-col gap-1 items-center text-center">
            ...
            <p>El proyecto es de <a href="https://codecademy.com" target="_blank">CodeCademy</a>, si gustas date una vuelta y revisa todas las especificaciones para que puedas ver de qué es capaz el proyecto.</p>
